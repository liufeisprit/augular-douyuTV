...
.directive('lazySrc', ['$window', '$document', function($window, $document){
    ...
    function isVisible(iElement){
        var elem = iElement[0],
            ...
            winOffsetY = windowOffset.offsetY+100,
            elemWidth = elemRect.width || elem.width,
            elemHeight = elemRect.height || elem.height+100,
...
//  var shop=document.querySelector(".p_shop");
//  shop.onscroll=function(){
//  	checkImage();
//  }
